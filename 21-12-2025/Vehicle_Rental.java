...
//         this.sc = sc;
//     }
//     double types(int ch, double me, int days) {
//         if (ch == 1) {
//             return 80 * days;
//         } else if (ch == 2) {
...
//             int choice;
//             Vehicle ve = new Car(inp);
//             // Vehicle sc = new Vehicle(inp);
//             while (true) {
...
//                         }
//                         // ve.types(ch, mem, day);
//                         System.out.println("Rental for ur Vehicle : " + re);
//                         System.out.println();
//                     }
//                     case 3 -> {
//                         return;
